  ...
  return (  
    <>
      ...
      <form className="form-reserva" onSubmit={handleSubmit}>
        ...
        <select className="select-reserva" name="marca" onChange={handleChange}>
          <option disabled selected>marca</option> 
          {opcionesVehiculo.map((e)=>(
            <option value={e.value}>{e.label}</option>
          ))}
        </select>
        <select className="select-reserva" name="año" onChange={handleChange}>
        ...
        <input
           ...
           type="date"
        />
        <select className="select-reserva" name="hora" onChange={handleChange}>
